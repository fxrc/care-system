<template>
  <div>
    ...
    <el-row style="margin-top:30px" type="flex" justify="center">
      <el-col :span="6">
        <el-upload drag :action="dataUpdateScoreUrlT" multiple show-file-list name="file"
                   :on-success="funGetSuccessResponse" :on-error="funGetErroeResponse" :before-upload="funBeforeUpload">
