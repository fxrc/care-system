<template>
  <div>
    <el-row style="margin-top:30px">
      <el-col :span='20' :offset='2'>
        <el-card class="box-card">
            ...
            <el-col :span='4'>
              <div style="display: flex;margin-left:10px">
                <el-tooltip effect="light" content="新建事件" :enterable="false" :open-delay="300" placement="top">
                  <i :class="addNewEventClass" @click="eventDialogFormVisible = true" @mousemove="changeIcon(0 , 'addNewEventClass')" @mouseout="changeIcon(1, 'addNewEventClass')" style="padding-top: 6px;"></i>
                </el-tooltip>
          ...
          <el-dialog title="新建事件" :visible.sync="eventDialogFormVisible" size='tiny' @open="resetForm(eventFormContent)">
              ...
              <el-col :span="18" :offset="3">
                <el-form :model="eventFormContent" :ref="eventFormContent" label-position="right" :rules="rules">
                  ...
                  <el-form-item label="事件时间:" :label-width="formLabelWidth" prop="time">
                    <el-date-picker v-model="eventFormContent.time" type="datetime" placeholder="请选择时间" style="width: 100%;">
                    </el-date-picker>
                  </el-form-item>
                  <el-form-item label="事件内容:" :label-width="formLabelWidth" prop="content">
                    <el-input v-model="eventFormContent.content" :autosize="{ minRows: 5, maxRows: 10}" type="textarea"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="18" :offset="3">
                <el-form :model="addFocusFormContent" :ref="addFocusFormContent" label-position="right">
                  ...
                  <el-form-item label="关注原因:" :label-width="formLabelWidth" prop="focusReason" :rules="[{ required: true, message: '原因不能为空' }, { min: 8, message: '长度至少 8 个字符', trigger: 'blur' }]">
                    <el-input v-model="addFocusFormContent.focusReason" :autosize="{ minRows: 5, maxRows: 10}" type="textarea"></el-input>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
          ...
          <el-row style="margin-top:30px">
            <el-col>
              <el-form label-width="100px" :inline="true">
                <el-form-item v-for="(domain, index) in stuBicData.propName" :label="stuBicData['colName'][index] + ':'" :key="index" v-if="stuBicData['colName'][index]!='姓名'">
                  <el-input v-model="stuBicData.data[stuBicData['propName'][index]]" readonly></el-input>
                </el-form-item>
              </el-form>
            </el-col>
          </el-row>
          <el-row v-if="((this.stuFocusInfo['focusLevel']!='正常')&&(this.stuFocusInfo['focusLevel']!='毕业'))" style="margin-top:30px">
      ...
      <el-col :span="22" :offset="1">
        ...
        <el-row :gutter="40" justify style="position: relative; left: 20%; top: 20px">
          <el-col :span="5" :offset="6">
            <el-input placeholder="模糊搜索" icon="search" v-model="inputDataForSearch1" :on-icon-click="filterByInputDataForSearch1" @keyup.enter.native="filterByInputDataForSearch1">
            </el-input>
          </el-col>
          <el-col :span="3">
    ...
    <el-row>
      <el-col :span="22" :offset="1">
        <el-pagination style="float:right" @current-change="handleCurrentChange" :current-page.sync="currentPage1" :page-size="10" layout="total, prev, pager, next, jumper" :total="stuScoreNum">
        </el-pagination>
      </el-col>
    </el-row>
    <el-row style="margin-top:30px">
    ...
    <el-row>
      <el-col :span="22" :offset="1">
        <el-pagination style="position: relative;left: 60%" @current-change="handleCurrentChange3" :current-page.sync="currentPage3" :page-size="10" layout="total, prev, pager, next, jumper" :total="stuTripNum">
        </el-pagination>
      </el-col>
    </el-row>
    <el-row style="margin-top:30px">
    ...
    <el-row>
      <el-col :span="22" :offset="1">
        <el-pagination style="position: relative;left: 60%" @current-change="handleCurrentChange2" :current-page.sync="currentPage2" :page-size="10" layout="total, prev, pager, next, jumper" :total="stuCardNum">
        </el-pagination>
      </el-col>
    </el-row>
    <el-row style="margin-top:30px">
  ...
  methods: {
    ...
    change2() {
      if (this.value2[0] == null) {
        this.currentPage2 = 1
        this.stuCardShow['data'] = this.stuCard['data']
    ...
    change1() {
      if (this.value1[0] == null) {
        this.currentPage3 = 1
        this.stuTripShow['data'] = this.stuTrip['data']
