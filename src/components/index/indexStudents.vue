    ...
    <div>
        ...
        <el-row style="margin-top:30px">
            <el-col :span="22" :offset="1">
                <el-table :data="tableInfoShow['data']" style="width: 100%" highlight-current-row v-loading.body="loadingTable" height="500">
                    ...
                    <el-table-column label="操作" align='center'>
                        <template scope="scope">
                            <i v-run="register(scope.$index)" :class="iconClassMouseOut" @click="handleEdit(scope.$index, scope.row)" @mousemove="changeIcon(0, scope.$index)" @mouseout="changeIcon(1, scope.$index)"></i>
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
        ...
        <el-row>
            <el-col :span="22" :offset="1">
                <el-pagination style="float:right" @current-change="handleCurrentChange" :current-page.sync="currentPage1" :page-size="10" layout="total, prev, pager, next, jumper" :total="stuNum">
                </el-pagination>
            </el-col>
        </el-row>
    </div>
